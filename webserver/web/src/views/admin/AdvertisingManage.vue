  ...
  <div>
      ...
      <el-card>
        <el-form ref="searchFormComponents" :model="searchForm" inline>
          <el-form-item label="位置" prop="position">
            <el-select v-model="searchForm.position" placeholder="请选择" clearable filterable style="width: 150px">
    ...
    >
      <el-form ref="formRef" :model="formData" label-width="100px">
        <slot name="content">
          <el-form-item label="位置" prop="position"  :rules="[{required:true,message:'不能为空',trigger:[ 'blur','change']}]">
...
const  positionList=ref(['顶部','轮播图左侧','轮播图右侧'])
